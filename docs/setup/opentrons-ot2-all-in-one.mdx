...
=======
See the [Opentrons OT-2 edge user guide](https://github.com/PUDAP/puda-opentrons-edge/blob/main/user-guide.md) for machine-specific commands and workflows.

From here, use [Using PUDA](../category/using-puda) to run protocols, build repeatable OT-2 workflows, and more.
>>>>>>> 957d28d6655c332ff525acd7e22340166e367f56
