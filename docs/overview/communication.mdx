...
For long-term storage, run a dedicated [logging service](../observability/logging-service) that subscribes to the subjects you care about and writes them to a database.
