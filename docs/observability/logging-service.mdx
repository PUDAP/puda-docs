...
Copy the server environment file and start InfluxDB:
...
- Connect [Grafana](./grafana-observability) to InfluxDB for dashboards and alerts on machine health and command history.
